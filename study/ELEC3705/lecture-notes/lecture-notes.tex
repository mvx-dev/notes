...
\indent\textbf{At an initial time, the state of a quantum system is specified by a ket that belongs to a suitable vector space.}
...
The second postulate of quantum mechanics: \textbf{Every measurable physical quantity is described by an operator, which must be an observable}.
